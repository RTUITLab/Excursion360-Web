...
import type { int, Nullable } from "@babylonjs/core/types";
...
export class CustomButton3D extends AbstractButton3D {
	...
	public set content(value: Control) {
		...
		if (!this._customFacadeTexture) {
			this._customFacadeTexture = new AdvancedDynamicTexture(
				"Facade",
			...
			this._customFacadeTexture.rootContainer.scaleX =
				this._customContentScaleRatio;
			this._customFacadeTexture.rootContainer.scaleY =
				this._customContentScaleRatio;

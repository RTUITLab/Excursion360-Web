...
import type { Control3D } from "@babylonjs/gui/3D/controls/control3D";
...
export class CustomHolographicButton extends Button3D {
	...
	protected _applyFacade(facadeTexture: AdvancedDynamicTexture) {
		facadeTexture.scaleTo(
			this._options.width *
				(typeof this.contentResolution === "number"
					? this.contentResolution
					: this.contentResolution.width),
			this._options.height *
				(typeof this.contentResolution === "number"
					? this.contentResolution
					: this.contentResolution.height),
		);
